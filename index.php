...
<section class="zhuoer-archive">
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'zhuoer-entry' ); ?>>
                    ...
                    <footer class="zhuoer-entry__footer">
                        <a href="<?php the_permalink(); ?>" class="zhuoer-read-more">
                            <?php esc_html_e( 'Read more', 'zhuoer' ); ?>
    ...
    <?php else : ?>
        <div class="zhuoer-no-results">
            <h2 class="zhuoer-page__title"><?php esc_html_e( 'Nothing found', 'zhuoer' ); ?></h2>
            <p class="zhuoer-error-page__text"><?php esc_html_e( 'It seems we can\'t find what you\'re looking for.', 'zhuoer' ); ?></p>
        </div>
    <?php endif; ?>
</section>
