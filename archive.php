...
<h1 class="zhuoer-page__title"><?php echo esc_html( get_the_author() ); ?></h1>
<?php elseif (is_year()) : ?>
...
<?php else : ?>
<h1 class="zhuoer-page__title"><?php esc_html_e( '归档', 'zhuoer' ); ?></h1>
<?php endif; ?>
</div>
...
<h2 class="zhuoer-entry__title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php echo esc_html( get_the_title() ); ?></a></h2>
